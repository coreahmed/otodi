    ...
    <footer className="footer-main">
      <div className="footer-container-main">
        <div className="company-info">
          <a href={uris.index}><img src={logo} alt="company logo"/></a>
          <p>OTODI is a Bangladesh-based furniture manufacturer and retailer. The company was established in 1975 by Abdullah.</p>
        </div>
        ...
        <div className="footer-menu">
          ...
          <address>
              Email to <a href="mailto:avvdullah@gmail.com" className="email">Abdullah Al Fahim</a> <br />
